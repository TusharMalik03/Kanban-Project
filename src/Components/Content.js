import { AddSquare, ArrowDown2, Calendar1,FilterSearch, Link21, Menu, Pause, Profile2User } from 'iconsax-react'
    ...
    <section className=" my-10 md:px-10 px-2 ">
        ...
        <div className=" flex justify-start  space-x-5  ">
          ...
          <div className=" flex items-center justify-center space-x-5 ">
            ...
            <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.13749 1.80001L2.64998 8.28751C2.39998 8.53751 2.16249 9.02501 2.11249 9.37501L1.76249 11.85C1.63749 12.75 2.26249 13.375 3.16249 13.25L5.63746 12.9C5.98746 12.85 6.475 12.6125 6.725 12.3625L13.2125 5.87501C14.325 4.76251 14.8625 3.46251 13.2125 1.81251C11.5625 0.150005 10.2625 0.675007 9.13749 1.80001Z" stroke="#5030E5" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            </button>
            <button className=" rounded-md bg-[#5030E533] p-1 ">
      ...
      <div className=" my-10 flex items-center justify-between font-medium text-grayColor ">
        <div className="flex items-center justify-center gap-5  ">
          ...
          <button className=" flex items-center md:hidden sm:block justify-center space-x-2 rounded-md border border-grayColor px-3 md:py-2 py-1 ">
